...
mobile: MethodMobile, 
browser: opcion == '1' ? ['HachikoBotLite-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['HachikoBotLite-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './HachikoJadiBot';
...
const mainBotAuthFile = 'HachikoSession';
try {
